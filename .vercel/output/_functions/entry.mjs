...
var middlewareSecret = "5f5b11ad-a958-4e2b-a13e-6708f44bc68a";
//#endregion
...
[
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/contato.astro",
			"pathname": "/contato",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/servicos.astro",
			"pathname": "/servicos",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/sobre.astro",
			"pathname": "/sobre",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
...
var _page0 = () => import("./chunks/generic_eEt92ifq.mjs").then((n) => n.t);
var _page1 = () => import("./chunks/contato_DWc-K2xX.mjs");
var _page2 = () => import("./chunks/servicos_DJoSGyii.mjs");
var _page3 = () => import("./chunks/sobre_Cfa0CWbs.mjs");
var _page4 = () => import("./chunks/index_Hrpoj9eo.mjs");
var pageMap = /* @__PURE__ */ new Map([
	["node_modules/astro/dist/assets/endpoint/generic.js", _page0],
	["src/pages/contato.astro", _page1],
	["src/pages/servicos.astro", _page2],
	["src/pages/sobre.astro", _page3],
	["src/pages/index.astro", _page4]
]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///D:/Drivers/OneDriveLeo/OneDrive/Coisas_Leonardo/gits/Tereshkova_Engenharia/","cacheDir":"file:///D:/Drivers/OneDriveLeo/OneDrive/Coisas_Leonardo/gits/Tereshkova_Engenharia/node_modules/.astro/","outDir":"file:///D:/Drivers/OneDriveLeo/OneDrive/Coisas_Leonardo/gits/Tereshkova_Engenharia/dist/","srcDir":"file:///D:/Drivers/OneDriveLeo/OneDrive/Coisas_Leonardo/gits/Tereshkova_Engenharia/src/","publicDir":"file:///D:/Drivers/OneDriveLeo/OneDrive/Coisas_Leonardo/gits/Tereshkova_Engenharia/public/","buildClientDir":"file:///D:/Drivers/OneDriveLeo/OneDrive/Coisas_Leonardo/gits/Tereshkova_Engenharia/dist/client/","buildServerDir":"file:///D:/Drivers/OneDriveLeo/OneDrive/Coisas_Leonardo/gits/Tereshkova_Engenharia/dist/server/","adapterName":"@astrojs/vercel","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/contato","isIndex":false,"type":"page","pattern":"^\\/contato\\/?$","segments":[[{"content":"contato","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/contato.astro","pathname":"/contato","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/servicos","isIndex":false,"type":"page","pattern":"^\\/servicos\\/?$","segments":[[{"content":"servicos","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/servicos.astro","pathname":"/servicos","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/sobre","isIndex":false,"type":"page","pattern":"^\\/sobre\\/?$","segments":[[{"content":"sobre","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/sobre.astro","pathname":"/sobre","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","site":"https://tereshkovaengenharia.com.br","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["D:/Drivers/OneDriveLeo/OneDrive/Coisas_Leonardo/gits/Tereshkova_Engenharia/src/pages/contato.astro",{"propagation":"none","containsHead":true}],["D:/Drivers/OneDriveLeo/OneDrive/Coisas_Leonardo/gits/Tereshkova_Engenharia/src/pages/index.astro",{"propagation":"none","containsHead":true}],["D:/Drivers/OneDriveLeo/OneDrive/Coisas_Leonardo/gits/Tereshkova_Engenharia/src/pages/servicos.astro",{"propagation":"none","containsHead":true}],["D:/Drivers/OneDriveLeo/OneDrive/Coisas_Leonardo/gits/Tereshkova_Engenharia/src/pages/sobre.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","@astrojs/vercel/entrypoint":"entry.mjs","\u0000virtual:astro:page:src/pages/contato@_@astro":"chunks/contato_DWc-K2xX.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_eEt92ifq.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_Hrpoj9eo.mjs","\u0000virtual:astro:page:src/pages/servicos@_@astro":"chunks/servicos_DJoSGyii.mjs","D:/Drivers/OneDriveLeo/OneDrive/Coisas_Leonardo/gits/Tereshkova_Engenharia/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_3iaAIc0z.mjs","\u0000virtual:astro:page:src/pages/sobre@_@astro":"chunks/sobre_Cfa0CWbs.mjs","D:/Drivers/OneDriveLeo/OneDrive/Coisas_Leonardo/gits/Tereshkova_Engenharia/src/pages/contato.astro?astro&type=script&index=0&lang.ts":"_astro/contato.astro_astro_type_script_index_0_lang.CpjkjJmV.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["D:/Drivers/OneDriveLeo/OneDrive/Coisas_Leonardo/gits/Tereshkova_Engenharia/src/pages/contato.astro?astro&type=script&index=0&lang.ts","document.getElementById(`contact-form`).addEventListener(`submit`,async function(e){e.preventDefault();let t=e.target,n=document.getElementById(`submit-btn`),r=document.getElementById(`form-status`);n.disabled=!0,n.innerHTML=`<span>Enviando...</span> <i class=\"fas fa-spinner fa-spin\"></i>`,r.textContent=``,r.className=`form-status`;try{if((await fetch(t.action,{method:`POST`,body:new FormData(t),headers:{Accept:`application/json`}})).ok)r.innerHTML=`<i class=\"fas fa-check-circle\"></i> Mensagem enviada com sucesso! Entraremos em contato em breve.`,r.className=`form-status success`,t.reset();else throw Error(`Erro ao enviar`)}catch{r.innerHTML=`<i class=\"fas fa-exclamation-circle\"></i> Ocorreu um erro. Por favor, tente novamente mais tarde.`,r.className=`form-status error`}finally{n.disabled=!1,n.innerHTML=`<span>Enviar Mensagem</span> <i class=\"fas fa-paper-plane\"></i>`}});"]],"assets":["/images/logo-footer.png","/images/logo.png"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"CZbgMrc2tKaFlQSmSMpS1iOIW3wwKiHoYn4neRSWZuM=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "5f5b11ad-a958-4e2b-a13e-6708f44bc68a") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
